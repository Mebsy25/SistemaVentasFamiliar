    ...
    public partial class frmVentas : Form
    {
        ...
        private void txtcodproducto_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Enter)
            {
                ...
                Producto oProducto = new NegocioProductos().Listar().Where(p => p.Codigo == txtcodproducto.Text && p.Estado == true).FirstOrDefault();
        ...
        private void btnagregarproducto_Click(object sender, EventArgs e)
        {
            ...
            if (!producto_existe)
            {
                ...
                bool respuesta = new NegocioVenta().RestarStock(
        ...
        private void dgvdata_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvdata.Columns[e.ColumnIndex].Name == "btneliminar")
            {
                ...
                if (index >= 0)
                {
                    bool respuesta = new NegocioVenta().SumarStock(
        ...
        private void btncrearventa_Click(object sender, EventArgs e)
        {
            ...
            int idcorrelativo = new NegocioVenta().ObtenerCorrelativo();
            ...
            bool respuesta = new NegocioVenta().Registrar(oVenta, detalle_venta, out mensaje);
